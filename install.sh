...
AGENTS_TEMPLATE_DIR="${TEMPLATE_DIR}/agents"
AGENT_PROMPTS_TEMPLATE_DIR="${TEMPLATE_DIR}/agents-prompts"
RULES_TEMPLATE_DIR="${TEMPLATE_DIR}/rules"
SKILLS_TEMPLATE_DIR="${TEMPLATE_DIR}/skills"
MULTI_BASE_TEMPLATE="${AGENT_PROMPTS_TEMPLATE_DIR}/MULTI_BASE.md"
ORCHESTRATOR_PLAYBOOK_TEMPLATE="${AGENT_PROMPTS_TEMPLATE_DIR}/ORCHESTRATOR.md"
...
require_file "$AGENTS_TEMPLATE_DIR"
require_file "$AGENT_PROMPTS_TEMPLATE_DIR"
require_file "$RULES_TEMPLATE_DIR"
require_file "$SKILLS_TEMPLATE_DIR"
require_file "$MULTI_BASE_TEMPLATE"
require_file "$ORCHESTRATOR_PLAYBOOK_TEMPLATE"
